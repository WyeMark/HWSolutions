report 50002 "Check (Stub/Stub/Check) - H&W"
{
    // //H&W Layout and data structure
    // //DW1.00 - Clear check number
    // //DW1.01 - Clear Payee number
    DefaultLayout = RDLC;
    RDLCLayout = './src/reports/Check (StubStubCheck) - H&W.rdlc';

    Caption = 'H&W Check (Stub/Stub/Check)';
